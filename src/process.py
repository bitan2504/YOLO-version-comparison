...
from src.run_yolo import run_yolo


def process(video_path: str, models: list[str]) -> None:
    ...
    for model in models:
        ...
        multiple_people_detected, absence_detected = run_yolo(frames_dir, frame_files, yolo_configs, model_path, fps_rounded)
